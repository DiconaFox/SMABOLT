...
> ⚠️Следующее ппредупреждение**"Подозрительное приложение заблокировано"**  появляется потому, что приложение установлено не из Google Play.** Я гарантирую, что оно безопасно!** Ввесь код открыт и доступен в этом репозитории.
